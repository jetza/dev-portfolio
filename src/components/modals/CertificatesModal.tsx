...
export default function CertificatesModal({ isOpen, onClose, cardPosition }: CertificatesModalProps) {
            ...
            <div className="flex-shrink-0 bg-black/95 backdrop-blur-md p-6 border-b border-lime-400/30 z-10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <Award className="w-12 h-12 text-lime-400 drop-shadow-[0_0_15px_rgba(163,230,53,0.5)]" />
                  <div>
                    <h2 className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-white">
                      Certificates
                    </h2>
                    <p className="text-gray-400 text-sm mt-1">Professional certifications</p>
                  </div>
                </div>
                <motion.button 
                ...
                {certificates.map((cert, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="text-lg font-black text-lime-400 group-hover:text-magenta-400 transition-colors">
                        {cert.title}
                      </h3>
                    ...
                    {cert.link && (
                      <a 
                        ...
                        className="inline-flex items-center gap-2 mt-4 text-sm text-lime-400 hover:text-magenta-400 transition-colors"
                      >

      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {certificates.map((cert, index) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-lime-400 mb-2 group-hover:text-white transition-colors drop-shadow-[0_0_8px_rgba(163,230,53,0.5)] line-clamp-2">{cert.title}</h3>
            <p className="text-cyan-400 text-sm mb-3 font-mono">{cert.issuer}</p>
